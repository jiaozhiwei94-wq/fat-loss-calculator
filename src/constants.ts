...
export const PLAN_LEVELS = [
  { id: 'comfort', label: '舒适', deficit: 300, comment: '循序渐进，极易坚持', impact: '对生活质量影响极小，适合长期维持。' },
  { id: 'standard', label: '标准', deficit: 500, comment: '科学高效，主流选择', impact: '减脂速度适中，能较好兼顾体能与生活。' },
  { id: 'strict', label: '严格', deficit: 800, comment: '快速见效，挑战意志', impact: '可能伴随饥饿感，建议在专业指导下进行。' },
  { id: 'manual', label: '自定义', deficit: 0, comment: '灵活调整', impact: '根据您的个人节奏自由设定。' },
];
